...
const addFont = () => {
  ...
  element3.innerHTML =
    ' พื้นที่จัดเก็บข้อมูล ให้กับแพลตฟอร์ม<br>หรือแอปพลิเคชัน ตามความต้องการ <br>ของผู้ใช้งานกลุ่มเฉพาะ ปลดล็อคข้อจำกัดต่าง ๆ<br>ด้วยเทคโนโลยีบริหารที่มีความยืดหยุ่น รองรับการ<br>ใช้งาน  เพิ่มประสิทธิภาพการทำงานสูงสุดและความ<br>ปลอดภัยที่เชื่อมโยงผู้ใช้งานเข้าด้วยกันได้อย่าง<br>ไร้รอยต่อตลอด 24 ชม.';
};
...
const removeFont = () => {
  ...
  let element3 = document.getElementById('content-home');
  element3.innerHTML =
    ' พื้นที่จัดเก็บข้อมูล ให้กับแพลตฟอร์ม หรือแอปพลิเคชัน <br> ตามความต้องการ ของผู้ใช้งานกลุ่มเฉพาะ ปลดล็อคข้อจำกัดต่าง ๆ<br>ด้วยเทคโนโลยีบริหารที่มีความยืดหยุ่น รองรับการใช้งาน<br>เพิ่มประสิทธิภาพการทำงานสูงสุดและความปลอดภัย<br>ที่เชื่อมโยงผู้ใช้งานเข้าด้วยกันได้อย่างไร้รอยต่อตลอด 24 ชม.';
};
